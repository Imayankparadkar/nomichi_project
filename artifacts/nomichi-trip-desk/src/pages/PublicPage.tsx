...
function FloatingCard({ trip, index }: { trip: Trip; index: number }) {
  ...
  return (
    <div
      ...
      style={{ top: cfg.top, right: cfg.right, zIndex: cfg.zIndex, animationDelay: cfg.delay }}
    >
      <div
...
export default function PublicPage() {
  ...
  return (
    <div style={{ backgroundColor: VOID, minHeight: "100vh", color: "#FFFBF5" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button
              ...
              className="text-sm font-poppins underline-anim"
              style={{ color: "rgba(255,251,245,0.45)" }}
            >
              Journeys
            </button>
            <Link
      ...
      {/* ── Hero ────────────────────────────────────────────────── */}
      <section
        className="min-h-[calc(100vh-65px)] flex flex-col justify-center relative overflow-hidden"
        style={{ backgroundColor: VOID }}
      >
        {/* Glow orbs */}
        <div className="absolute pointer-events-none" style={{
          top: "5%", right: "-5%", width: "700px", height: "600px",
          background: "radial-gradient(ellipse at center, rgba(213,93,39,0.18) 0%, transparent 65%)",
          filter: "blur(60px)", animation: "glow-breathe 5s ease-in-out infinite",
        }} />
        <div className="absolute pointer-events-none" style={{
          bottom: "10%", right: "20%", width: "400px", height: "400px",
          background: "radial-gradient(ellipse at center, rgba(69,71,29,0.22) 0%, transparent 65%)",
          filter: "blur(50px)", animation: "glow-breathe 7s ease-in-out infinite reverse",
        }} />
        <div className="absolute pointer-events-none" style={{
          top: "40%", left: "-10%", width: "500px", height: "400px",
          background: "radial-gradient(ellipse at center, rgba(213,93,39,0.06) 0%, transparent 70%)",
          filter: "blur(80px)",
        }} />
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div>
            ...
            <h1
              ...
              style={{ fontSize: "clamp(2.8rem, 5.5vw, 5.5rem)", animationDelay: "60ms" }}
            >
              Where do
              <br />
              you want
              <br />
              <em style={{ color: "#D55D27", fontStyle: "italic" }}>to find</em>
              <br />
              <em style={{ color: "#D55D27", fontStyle: "italic" }}>yourself?</em>
            </h1>

            <p
              className="font-poppins text-lg leading-relaxed max-w-md mb-10 animate-fade-up"
              style={{ color: "rgba(255,251,245,0.5)", animationDelay: "140ms" }}
            >
      ...
      {/* ── Trips section ───────────────────────────────────────── */}
      <section id="trips-section" className="py-24" style={{ backgroundColor: DARK }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          {submitted && (
            <div
              className="mb-12 border-l-4 border-rust px-6 py-5 animate-slide-right flex gap-4 items-start"
              style={{ background: "rgba(213,93,39,0.07)" }}
            >
              ...
              <div>
                ...
                <Link href="/status" className="text-rust text-sm font-poppins underline-anim">
          ...
          {loading ? (
            <div
              ...
              style={{ background: "rgba(255,251,245,0.02)", borderColor: "rgba(255,251,245,0.07)" }}
            >
            ...
            <div className="animate-fade-up">
              <button
                ...
                className="flex items-center gap-2 text-sm font-poppins mb-8 underline-anim"
                style={{ color: "rgba(255,251,245,0.45)" }}
              >
                ← Back to trips
              </button>
            ...
            >
              ...
              <p className="font-poppins text-sm" style={{ color: "rgba(255,251,245,0.4)" }}>
      ...
      <footer
        ...
        style={{ backgroundColor: VOID, borderColor: "rgba(255,251,245,0.05)" }}
      >
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/status" className="text-xs font-poppins underline-anim" style={{ color: "rgba(255,251,245,0.3)" }}>
              Track enquiry
            </Link>
            <span style={{ color: "rgba(255,251,245,0.1)" }}>·</span>
            <span className="text-xs font-poppins uppercase tracking-widest" style={{ color: "rgba(255,251,245,0.2)" }}>
