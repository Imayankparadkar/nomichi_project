  ...
  return (
    <div style={{ backgroundColor: VOID, color: "#FFFBF5", width: "100%" }}>
      ...
      <section
        ...
        style={{ backgroundColor: VOID, minHeight: "calc(100vh - 65px)", display: "flex", alignItems: "center" }}
      >
        {/* Glow orbs */}
        <div className="absolute pointer-events-none" style={{ top: "5%", right: "-5%", width: "700px", height: "600px", background: "radial-gradient(ellipse at center, rgba(213,93,39,0.18) 0%, transparent 65%)", filter: "blur(60px)", animation: "glow-breathe 5s ease-in-out infinite" }} />
        <div className="absolute pointer-events-none" style={{ bottom: "10%", right: "20%", width: "400px", height: "400px", background: "radial-gradient(ellipse at center, rgba(69,71,29,0.22) 0%, transparent 65%)", filter: "blur(50px)", animation: "glow-breathe 7s ease-in-out infinite reverse" }} />
        <div className="absolute pointer-events-none" style={{ top: "40%", left: "-10%", width: "500px", height: "400px", background: "radial-gradient(ellipse at center, rgba(213,93,39,0.06) 0%, transparent 70%)", filter: "blur(80px)" }} />

        {/* Hero content */}
        <div className="page-container py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          {/* Left */}
          <div>
            <p className="text-xs uppercase tracking-[0.28em] text-rust font-poppins font-medium mb-6 animate-fade-in" style={{ animationDelay: "0ms" }}>
              Open journeys
            </p>
